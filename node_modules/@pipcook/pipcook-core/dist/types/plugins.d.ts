...
export declare type PluginTypeI = 'dataCollect' | 'dataAccess' | 'dataProcess' | 'datasetProcess' | 'modelLoad' | 'modelDefine' | 'modelTrain' | 'modelEvaluate';
/**
 * The plugin installation protocol
 */
export declare type PluginSourceProtocol = 'fs' | 'npm' | 'git' | 'tarball';
/**
